...
(SystemConfiguration.md). Provided in the shared layer because ``run_meta.json`` must
...
measurement rule depends on encapsulation being separable:
    ...
    global.yaml, Exp. 1: "ML-KEM-768 encapsulation runs once at session
...
def measure_setup_cost(repetitions: int = 30) -> dict[str, object]:
    ...
    global.yaml keeps this OUT of the Exp. 1 curve and asks for it in the text
