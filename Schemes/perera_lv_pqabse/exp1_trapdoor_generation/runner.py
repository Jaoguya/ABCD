...
ML-KEM encapsulation is EXCLUDED, per global.yaml's Exp. 1 boundary: it happens
...
# global.yaml default index size. Exp. 1 does not search, so this only has to be
