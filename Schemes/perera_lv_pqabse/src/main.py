...
disclaims fine-grained revocation.
"""
...
def _report_setup_cost() -> None:
    """global.yaml, Exp. 1: session establishment is reported separately.
    ...
    try:
        ...
        return
    print(
        f"  session establishment (EXCLUDED from Exp. 1, global.yaml): "
