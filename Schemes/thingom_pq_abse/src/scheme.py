...
Implemented as published (skill.md). Section and line citations point at
...
problems, which quantum computers can solve effectively". Per skill.md the
...
----------------------------
Ref[41] runs Exp. 1, 2 and 3 only (41.md). Those exercise setup, key
...
class Trapdoor:
    ...
    q-keyword query means q of these — see 41.md for how Exp. 1 handles it.
    """
...
class QueryPlan:
    ...
    claims, which skill.md forbids in the same breath as speeding a
    baseline up.
    """
