...
#
# Building once and cloning is not just faster. It makes SystemConfiguration.md's parity
...
if [[ "${VERSION_ID:-}" != "22.04" ]]; then
    echo "WARNING: this is ${PRETTY_NAME}, but SystemConfiguration.md specifies Ubuntu 22.04 LTS."
